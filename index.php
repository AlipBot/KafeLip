<html lang="en">
 <head>
  ...
  <style>
   .explore-menu:hover, .get-started:hover, #scrollToTopBtn:hover {
    background-color: #68B0AB;
        ...
        .nav a:hover::after, .goMenu a:hover::after {
            width: 100%;
        }
  </style>
 </head>
 <body class="bg-[#FAF3DD] font-poppins">
  <div class="w-full bg-[#FAF3DD]">
   <div class="container mx-auto flex justify-between items-center py-6 px-4">
    <div class="logo text-2xl font-bold flex items-center mr-4">
     <i class="fas fa-coffee text-[#8FC0A9] mr-2">
     </i>
    ...
    <div class="nav flex gap-6 mx-auto">
     <a class="text-black font-medium active:text-[#8FC0A9]" href="#">
      <i class="fas fa-home text-[#8FC0A9] mr-1">
      </i>
      <span>
       LAMAN UTAMA
      </span>
     ...
     <a class="text-black font-medium" href="#">
      <i class="fas fa-info-circle text-[#8FC0A9] mr-1">
      </i>
      <span>
       INFO
      </span>
    ...
    <div class="goMenu flex gap-6">
     <a class="text-black font-medium" href="login.php">
      <i class="fas fa-sign-in-alt text-[#8FC0A9] mr-1">
      </i>
      <span>
       LOG MASUK
      </span>
     ...
     <a class="text-black font-medium" href="signup.php">
      <i class="fas fa-user-plus text-[#8FC0A9] mr-1">
      </i>
      <span>
       DAFTAR MASUK
      </span>
  ...
  <div class="w-full bg-[#FAF3DD]">
   <div class="container mx-auto py-12 px-10">
    <h2 class="text-4xl font-bold mb-6 relative inline-block text-center w-full text-black">
     Menu Menarik
     <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-1/2 h-1 bg-black">
     </span>
    </h2>
    <div class="flex flex-col gap-6">
     <div class="bg-[#8FC0A9] p-6 rounded-lg shadow-lg flex flex-col lg:flex-row-reverse items-center">
     ...
     <div class="bg-[#8FC0A9] p-6 rounded-lg shadow-lg flex flex-col lg:flex-row items-center">
  ...
  <div class="w-full bg-[#FAF3DD]">
   <div class="container mx-auto py-12 px-10">
    <div class="bg-[#8FC0A9] p-8 rounded-lg">
     <h2 class="text-4xl font-bold mb-6 relative inline-block text-center w-full text-white">
      Fakta Menarik Tentang Roti Canai
      <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-1/2 h-1 bg-[#68B0AB]">
      </span>
     </h2>
